--not my script, wanted to customise this a bit
...
local cfglocation = "TavaWarecfg/" 
makefolder("TavaWarecfg") 
...
function library:New(name) 
	...
	TavaWare.Name = "Suck my dick" 
	TavaWare.ResetOnSpawn = false 
	TavaWare.ZIndexBehavior = "Global" 
	TavaWare.DisplayOrder = 420133769 

	local UIScale = INST("UIScale") 
	UIScale.Parent = TavaWare
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key) 
		if key.KeyCode == Enum.KeyCode.Insert then 
			TavaWare.Enabled = not TavaWare.Enabled 
			library.uiopen = TavaWare.Enabled 
		end 
	end) 
	...
	function menu:Tab(text) 
		...
		TextButton.MouseButton1Down:Connect(function() 
			if currenttab ~= text then 
				...
				library:Tween(TextButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(24, 57, 151)}) 
				currenttab = text 
				TabGui.Visible = true 
			end 
		end) 
		...
		function Tab:MSector(text, side) 
			...
			function MSector:Tab(text) 
				...
				TextButton.MouseButton1Down:Connect(function() 
					...
					tab1.Visible = true 
					library:Tween(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(24, 57, 151)}) 
				end) 
				...
				function tab:Element(type, text, data, callback) 
					...
					if type == "Jumbobox" then 
						...
						Drop.ZIndex = 5 
						Drop.ScrollBarImageColor3 = COL3RGB(24, 57, 151) 
							...
							do 
								...
								Button.MouseButton1Down:Connect(function() 
									if TBLFIND(Element.value.Jumbobox, v) then 
										...
										library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(24, 57, 151)}) 
									end 
									updatetext() 
							...
							for i,v in pairs(Drop:GetChildren()) do 
								if v.Name ~= "UIListLayout" then 
									if TBLFIND(val.Jumbobox, v.Name) then 
										v.TextLabel.TextColor3 = COL3RGB(24, 57, 151)
									else 
					...
					elseif type == "ToggleKeybind" then 
						...
						Color.Name = "Color" 
						Color.Parent = Button 
						Color.BackgroundColor3 = COL3RGB(24, 57, 151)
						...
						local function update() 
							if Element.value.Toggle then 
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(24, 57, 151)}) 
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)}) 
							else 
								keybindremove(text) 
						...
						do 
							...
							Always.Text = "Always" 
							Always.TextColor3 = COL3RGB(24, 57, 151)
							...
							for _,button in pairs(Frame:GetChildren()) do 
								if button:IsA("TextButton") then 
									button.MouseButton1Down:Connect(function() 
										...
										button.TextColor3 = COL3RGB(24, 57, 151) 
										values[tabname][sectorname][tabtext][text] = Element.value 
										callback(Element.value) 
									end) 
									button.MouseEnter:Connect(function() 
										if Element.value.Type ~= button.Text then 
											library:Tween(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(24, 57, 151)}) 
										end 
									end) 
									button.MouseLeave:Connect(function() 
										if Element.value.Type ~= button.Text then 
					...
					elseif type == "ToggleColor" then 
						...
						HueFrameGradient.Color = ColorSequence.new { 
							...
							ColorSequenceKeypoint.new(0.83, COL3RGB(24, 57, 151)), 
					...
					elseif type == "ToggleTrans" then 
						...
						TextLabel.Parent = Button 
						TextLabel.BackgroundColor3 = COL3RGB(24, 57, 151) 
						TextLabel.BackgroundTransparency = 1.000 
						TextLabel.Position = UDIM2(0, 32, 0, -1) 
						TextLabel.Size = UDIM2(0.111913361, 208, 1, 0) 
						TextLabel.Font = Enum.Font.SourceSansSemibold 
					...
					elseif type == "Slider" then 
						...
						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, COL3RGB(24, 57, 151)), ColorSequenceKeypoint.new(1, COL3RGB(24, 57, 151))} 
					...
					elseif type == "Button" then 
						...
						Button_2.MouseButton1Down:Connect(function() 
							TextLabel.TextColor3 = COL3RGB(24, 57, 151)
						...
						Button_2.MouseEnter:Connect(function() 
							library:Tween(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(24, 57, 151)}) 
						end) 
			...
			function Sector:Element(type, text, data, callback) 
				...
				if type == "ScrollDrop" then 
					...
					for i,v in ipairs(joe) do 
						do 
							...
							Frame.ScrollBarImageColor3 = COL3RGB(24, 57, 151)      
								...
								for _,bad in pairs(v.Frame:GetChildren()) do      
									if bad:IsA("TextButton") then      
										...
										if bad.Name == Element.value.Scroll[v.Name] then      
											bad.TextLabel.TextColor3 = COL3RGB(24, 57, 151)     
										end      
									end      
								end      
							end      
				...
				elseif type == "Scroll" then      
					...
					function Element:SetValue(val)      
						...
						library:Tween(Frame[Element.value.Scroll].TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(24, 57, 151)})      
						values[tabname][sectorname][text] = Element.value      
						callback(Element.value)      
					end      
					values[tabname][sectorname][text] = Element.value      
...
for _,lua in pairs(listfiles("Tavalua")) do
	local luaname = string.gsub(lua, "Tavalua\\", "")
	table.insert(allluas, luaname)
end

RunService.RenderStepped:Wait()

local gui = library:New("TavaWare") 
...
antiaim:Element("Dropdown", "pitch", {options = {"up", "down", "imposter", "random", "TavaWare",}}) 
...
others:Element("Toggle", "remove head (smh)") 
...
exploits:Element('Slider', 'speed speed', {min = 1, max = 100, default = 16}) 
...
exploits:Element("Button", "God Mode", function() pcall(function()
...
world:Element("Dropdown", "hitsound", {options = {"none", "skeet", "neverlose", "rust", "bag", "baimware", "osu", "Tf2", "Tf2 pan", "M55solix", "Slap", "1", "Minecraft", "jojo", "vibe", "ion", "epic", "retro", "quek", "Csgo", "🗿"}}) 
world:Element("Slider", "sound volume", {min = 1, max = 5, default = 3}) 
world:Element("Dropdown", "Killsound", {options = {"none", "skeet", "neverlose", "rust", "bag", "baimware", "osu", "Tf2", "Tf2 pan", "M55solix", "Slap", "1", "Minecraft", "jojo", "vibe", "ion", "epic", "retro", "quek", "Csgo", "🗿"}}) 
world:Element("Slider", "sound volume", {min = 1, max = 5, default = 3}) 
world:Element('Toggle', 'Killsoundtoggle')
world:Element('TextBox', 'Killsound', {placeholder = "id"})
...
client:Element("Toggle", "buy any grenade")
		...
		local saturationboost = Instance.new("ColorCorrectionEffect", workspace.CurrentCamera)
				client:Element("Toggle", "Boost Saturation", {}, function(tbl)
					if tbl.Toggle then
						saturationboost.Saturation = 1.4
				else
				saturationboost.Saturation = 0
				end
				end)  
				...
				Frame_2.BackgroundColor3 = Color3.fromRGB(24, 57, 151)
				Frame_2.BackgroundTransparency = 0.100
				Frame_2.BorderColor3 = Color3.fromRGB(24, 57, 151)
...
Spectators.BorderColor3 = Color3.fromRGB(24, 57, 151)
Spectators.Position = UDim2.new(0, 1, 0.400000012, 0)
...
Background.BorderColor3 = Color3.fromRGB(24, 57, 151)
...
movement:Element("Slider", "speed", {min = 0, max = 300, default = 40}) 
...
chat:Element("Toggle", "chat spam", nil, function(tbl) 
	if tbl.Toggle then 
		while values.misc.chat["chat spam"].Toggle do 
            game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "TavaWare" and "$$$ TavaWare $$$" or values.misc.chat.type.Dropdown == "Troll" and "YOUR ALWAYS DEAD WHEN IT COMES TO TAVA" or values.misc.chat.type.Dropdown == "Social Creds" and "😭😭😭 -9999999999999999999999 Social Credits 😭😭😭",  false, "Innocent", false, true)  
...
Hacks:Element("Button", "Vote Kick Yourself", nil, function()
...
loadstring(readfile("TavaWareLua\\"..values.misc["lua scripts"].lua.Scroll))()
end)
luascripts:Element("Button", "GodLike script", nil, function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/isomiax/fps-gui-v2/main/script"))()
end)
...
local buybot = misc:Sector("Buy Bot", "Left")
...
buybot:Element('Button', 'Buy M4A4', {}, function()
	local gun = "M4A4"
	local givefunc
	for _, v in pairs(getgc()) do
	local parentScript = rawget(getfenv(v), "script")
...
buybot:Element('Button', 'Buy CZ', {}, function()
	local gun = "CZ"
	local givefunc
	for _, v in pairs(getgc()) do
	local parentScript = rawget(getfenv(v), "script")
...
buybot:Element('Button', 'Buy Deagle', {}, function()
...
buybot:Element('Button', 'Buy Scout', {}, function()
	local gun = "Scout"
	local givefunc
	for _, v in pairs(getgc()) do
	local parentScript = rawget(getfenv(v), "script")
...
buybot:Element('Button', 'Buy R8', {}, function()
	local gun = "R8"
	local givefunc
	for _, v in pairs(getgc()) do
	local parentScript = rawget(getfenv(v), "script")
...
buybot:Element('Button', 'Buy SG', {}, function()
	local gun = "SG"
	local givefunc
	for _, v in pairs(getgc()) do
	local parentScript = rawget(getfenv(v), "script")
...
buybot:Element('Button', 'Buy Sickle', {}, function()
	local gun = "Sickle"
	local givefunc
	for _, v in pairs(getgc()) do
	local parentScript = rawget(getfenv(v), "script")
...
--[[buybot:Element('Button', '', {}, function()
	local gun = ""
	local givefunc
	for _, v in pairs(getgc()) do
	local parentScript = rawget(getfenv(v), "script")
...
local function PlayerAdded()
		...
		if values.rage.angles.enabled.Toggle and not DisableAA then 
			...
			local Pitch = values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "TavaWare" and -6 or values.rage.angles["pitch"].Dropdown == "random" and RANDOM(-10, 10)/10 or 2.5
			if values.rage.angles["extend pitch"].Toggle and (values.rage.angles["pitch"].Dropdown == "up" or values.rage.angles["pitch"].Dropdown == "down" or values.rage.angles["pitch"].Dropdown == "TavaWare" or values.rage.angles["pitch"].Dropdown == "180") then 
				Pitch = (Pitch*2)/1.6 
			end 
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current) 
	...
	if values.misc.chat["kill say"].Toggle then
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "whats crazy is tava always wins but thats just me tho", false, "Innocent", false, true)
	end
end)
game.Players.LocalPlayer.Status.Kills.Changed:Connect(function(val)
...
CreateHitElement("loading tava",Color3.new(220,220,220), 5, 0, 270,  0, 22)
CreateHitElement("made by PiRu#6183",Color3.new(220,220,220), 5, 0, 270,  0, 22)
